            ...
            fluidRow( 
                ...
                mainPanel(
                  ...
                  HTML("<div style='text-align: left; font-size: 12px; line-height: 1.4;'>
                         ...
                         recieving.The data about each major's income was taken from the <br>
                         United States Census Bureau where as the data about the livable <br>
                         wages per state come from the World Population Review.</i>
                        </div>")
                )
            )
        ),
